...
imgtube1=AveragePooling2D(padding="valid",pool_size=2, data_format="channels_last",strides=1)(imgtube1)
...
imgtube2 = BatchNormalization()(imgtube2)
imgtube2=Conv2D(filters=32, kernel_size=1, padding='same',
                activation='relu')(imgtube2)
imgtube2 = BatchNormalization()(imgtube2)
imgtube2=AveragePooling2D(padding="valid",pool_size=2, data_format="channels_last",strides=1)(imgtube2)
...
imgtube3=Conv2D(filters=32, kernel_size=1, padding='same',
                activation='relu')(imgtube3)
imgtube3 = BatchNormalization()(imgtube3)
imgtube3=AveragePooling2D(padding="valid",pool_size=2, data_format="channels_last",strides=1)(imgtube3)
imgtube3=Flatten()(imgtube3)

#combine network
comnet = concatenate([imgtube1, imgtube2,imgtube3])
comnet = Dense(64, activation='relu')(comnet)
output = Dense(9, activation='softmax')(comnet)
